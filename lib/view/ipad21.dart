...
class Ipad21 extends StatelessWidget {
  const Ipad21({super.key});
  ...
  navigation: () {
    Navigator.push(
      context, 
      MaterialPageRoute(builder: (context) => OdometerScreen())
    );
  },
),
          ...
          const Text("MAP LOOKUP -",style: TextStyle(fontSize: 24.0),),
               const SizedBox(
            height: 20.0,
          ),
          const Text("SELECT STARTING STATION",style: TextStyle(color: Colors.green,fontSize: 20.0,fontWeight: FontWeight.bold),),
               const SizedBox(
            height: 20.0,
          ),
