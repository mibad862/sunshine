        ...
        children: [
          ...
          Row(
            ...
            children: [
              furtherDetails(
                ...
                furtherText: 'Near Side (Left)',
                furtherChild: Text('Elec/Head LightLeft'),
              ),
              furtherDetails(
                currentTextStyle: currentTextStyle,
                furtherText: 'Vehicle Front',
                furtherChild: Text(""),
              ),
              furtherDetails(
                currentTextStyle: currentTextStyle,
                furtherText: 'Off Side (Right)',
                furtherChild: Text(''),
              ),
              furtherDetails(
                currentTextStyle: currentTextStyle,
                furtherText: 'Internal',
                furtherChild: Text(''),
              ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              furtherDetails(
                currentTextStyle: currentTextStyle,
                furtherText: 'Vehicle Rear',
                furtherChild: Text(''),
              ),
              furtherDetails(
                currentTextStyle: currentTextStyle,
                furtherText: 'Bins (Internal Damage)',
                furtherChild: Text(''),
              ),
